...
extern struct Unit gUnitArrayPurple[5];
extern struct Unit gUnitLookupExpa[25];

struct Unit * const _gUnitLookup[0x100] = { // unit lookup
    ...
    /* Expansion */
    [FACTION_BLUE + 0x3F] = gUnitLookupExpa + 0,

    [FACTION_PURPLE + 0x06] = gUnitLookupExpa + 1,
    [FACTION_PURPLE + 0x07] = gUnitLookupExpa + 2,
    [FACTION_PURPLE + 0x08] = gUnitLookupExpa + 3,
    [FACTION_PURPLE + 0x09] = gUnitLookupExpa + 4,
    [FACTION_PURPLE + 0x0A] = gUnitLookupExpa + 5,
    [FACTION_PURPLE + 0x0B] = gUnitLookupExpa + 6,
    [FACTION_PURPLE + 0x0C] = gUnitLookupExpa + 7,
    [FACTION_PURPLE + 0x0D] = gUnitLookupExpa + 8,
    [FACTION_PURPLE + 0x0E] = gUnitLookupExpa + 9,
    [FACTION_PURPLE + 0x0F] = gUnitLookupExpa + 10,
    [FACTION_PURPLE + 0x10] = gUnitLookupExpa + 11,
    [FACTION_PURPLE + 0x11] = gUnitLookupExpa + 12,
    [FACTION_PURPLE + 0x12] = gUnitLookupExpa + 13,
    [FACTION_PURPLE + 0x13] = gUnitLookupExpa + 14,
    [FACTION_PURPLE + 0x14] = gUnitLookupExpa + 15,
    [FACTION_PURPLE + 0x15] = gUnitLookupExpa + 16,
    [FACTION_PURPLE + 0x16] = gUnitLookupExpa + 17,
    [FACTION_PURPLE + 0x17] = gUnitLookupExpa + 18,
    [FACTION_PURPLE + 0x18] = gUnitLookupExpa + 19,
    [FACTION_PURPLE + 0x19] = gUnitLookupExpa + 20,
    [FACTION_PURPLE + 0x1A] = gUnitLookupExpa + 21,
    [FACTION_PURPLE + 0x1B] = gUnitLookupExpa + 22,
    [FACTION_PURPLE + 0x1C] = gUnitLookupExpa + 23,
    [FACTION_PURPLE + 0x1D] = gUnitLookupExpa + 24,
};
